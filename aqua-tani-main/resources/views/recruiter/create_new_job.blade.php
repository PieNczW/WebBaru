		...
		<div class="row mb-5">
			<div class="col-lg-12">
				<form method="POST" action="{{route('r.create_new_job')}}" enctype="multipart/form-data" class="p-4 p-md-5 border rounded">
					...
					<!-- responsibilities -->
					<div class="form-group">
						<label for="responsibilities">Tanggung Jawab / Job Desk  </label>
					...
					<!-- experiences -->
					<div class="form-group">
						<label for="experience">Pengalaman Kerja / Pendidikan  </label>
					...
					<!-- benefits -->
					<div class="form-group">
						<label for="benefits">Keuntungan Lainnya  </label>
